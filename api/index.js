...
if (!CHAT_ID) {
    console.error(
        "❌ TELEGRAM_CHAT_ID is missing from environment variables."
    );
}
    ...
    async (req, res) => {
        ...
        try {
            ...
            if (
                ...
                console.warn(
                    "⚠️ Ignoring callback from unauthorized chat:",
                    chatId
                );
            ...
            // so Telegram does not repeatedly
            // retry the same callback.
...
app.get(
    ...
    (req, res) => {
        ...
        res.status(200).json({
            ...
            webhook:
                "https://family-cake.vercel.app/telegram-webhook"
